            ...
            <div class="panel panel-default">
                <div class="panel-header">
                    <div class="row" style="margin-top: -1rem !important;">
                           <div class="col-md-4"><h4 class="page-header" style="margin-left: 10px; border-bottom: none"><b>Salary list (Case incentive for Staff not enrolled in PF)</b></h4></div>
                            <div class="col-md-6 text-end" style="margin-top: 3rem !important;">
                            <div class="row">
                                <div class="col-md-8">
                                    <form method="GET" action="{{ request('month') ? route('reports.slwithoutpf', ['month' => request('month')]) : route('reports.slwithoutpf') }}" id="monthlyReport-form">
                        ...
                        <?php 
                          if(request('month')!=null)
                                ...
                                else
                                {
                                 ...
                                 $amount = ($payslip != null) ? $payslip->ctc : 0;
