            ...
            <div class="panel panel-default">
                <div class="panel-header">
                    <div class="row" style="margin-top: -1rem !important;">
                           <div class="col-md-4"><h4 class="page-header" style="margin-left: 10px; border-bottom: none"><b>Salary list of Other Bank Account</b></h4></div>
                            <div class="col-md-6 text-end" style="margin-top: 3rem !important;">
                            <div class="row">
                                <div class="col-md-8">
                                    <form method="GET" action="{{ request('month') ? route('reports.sloba', ['month' => request('month')]) : route('reports.sloba') }}" id="monthlyReport-form">
