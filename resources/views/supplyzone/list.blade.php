            ...
            <div class="panel panel-default">
                <div class="panel-header">
                    <div class="row" style="margin-top: -1rem !important;">
                        <div class="col-md-4">
                            <h4 class="page-header" style="margin-left: 10px; border-bottom: none"><b>List of Supply Zones</b></h4>
                        </div>
                        ...
                        <div class="col-md-2 text-end" style="margin: 35px 0 20px;    border-bottom: none; margin-top: 3rem !important;">
                            <a href="{{route('supplyzone.create')}}"><button class="btn btn-primary">Add</button></a>
                        </div>
                    </div>
                </div>
                                    ...
                                    <tbody id="departmentTableBody">
                                        ...
                                        @foreach($supply_zones as $i=>$s)
                                            <tr>
                                                ...
                                                <td>{{$s->status}}</td>
                                                <td>
                                                    <a href="/sba-hr/public/supplyzone/edit/{{$s->id}}"><i class="fa fa-edit" style="font-size:20px;color:blue"></i></a>&nbsp;
                                                    <a onclick="Deletesupplyzone('{{$s->id}}')"><i class="fa fa-trash" style="font-size:20px;color:red"></i></a>
                                                </td>
                                            </tr>
                                        @endforeach
