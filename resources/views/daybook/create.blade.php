        ...
        <div class="col-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4>Create Showroom Day Book</h4>
                    <?php 
                        $total = session('total');
                        session(['total' => $total]);
                    ?>
                    ...
                    <form method="POST" action="{{ route('daybook.store') }}" >
                        ...
                        <div class="form-group row" id="hidden">
                            ...
                            <select name="type_id" id="Type_id" class="form-control" required>
                                <option value="F" {{ old('type_id') == 'F' ? 'selected' : '' }}>Front office Day book</option>
                             </select>
                            </div>
                        </div>
                    ...
                    <div class="row" style="margin-top:13px">
                      ...
                      <button type="button" onclick="checkDenominations()" class="btn btn-primary">Add</button>
                        ...
                        <div class="form-group text-center">
                            ...
                            <a href="{{ route('daybook.list') }}" type="button" class="btn btn-danger">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
