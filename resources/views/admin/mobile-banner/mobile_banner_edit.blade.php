        ...
        <div class="row">
          <div class="col-md-5">
            <div class="card card-primary">
              ...
              <form role="form" method="post" class="col-md-12" enctype="multipart/form-data" action="{{ route('mobile.banner.update') }}">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="type" >
                        <option value="Top" @if('Top' == $banner->type) selected @endif>Top</option>
                        <option value="Middle" @if('Middle' == $banner->type) selected @endif>Middle</option>
                    </select>
                </div>
