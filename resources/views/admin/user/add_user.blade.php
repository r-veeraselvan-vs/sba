          ...
          <div class="col-md-12">
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Create Admin / Rider</h3>
              </div>
              <form role="form" method="post" class="col-md-6" action="{{ route('user.save') }}">
                  @csrf
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control" name="role" >
                        ...
                        <option value="Riders" {{ ('Riders' == old('role')) ? 'selected' : '' }}>Riders</option>
                    </select>
                    @if ($errors->has('role')) 
