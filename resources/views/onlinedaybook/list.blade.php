            ...
            <div class="panel panel-default">
                <div class="panel-header">
                    <div class="row" style="margin-top: 2rem !important;" id="heading">
                        <div class="col-md-3 text-center"><b>List of Online Day Book</b></div>
                        <div class="col-md-3 text-center">

<form method="GET" action="{{ route('online.list') }}" id="daybook-form">
    @csrf
        ...
        <div class="col-md-6">
            ...
            <input id="end-date" type="date" class="form-control" name="end_date" value="{{request()->get('end_date')}}">
                        ...
                        <div class="col-md-6 row text-center">
                          ...
                          <a href="{{route('online.create', ['date' => request()->get('start_date') ])}}"><button class="btn btn-primary">Add Entry</button></a> 
                        </div>
                    </div>  
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          <?php 
            $daybook1 = \App\Models\OnlineDayBook::whereBetween('date',[request()->get('start_date'),request()->get('end_date')])->pluck('id');
            $denominations = \App\Models\Denomination::WhereIn('online_daybook_id',$daybook1);
        ...
        @if (count($daybook) > 0)
            @foreach ($daybook as $entry)
                     ...
                     <tr>
                        ...
                        <td>
                            <a href="{{ route('online.edit', ['id' => $entry->id ]) }}" ><i class="fa fa-edit" style="font-size:20px;color:blue"></i></a>&nbsp
                            <a onclick="deleteonlineDaybook('{{$entry->id}}')"><i class="fa fa-trash" style="font-size:20px;color:red"></i></a>
                        </td>
                    </tr>
                    @php
                        $i++;
