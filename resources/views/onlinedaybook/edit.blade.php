...
<div style="margin-top:1rem">
    <div class="row justify-content-center">
        ...
        <form method="POST" action="{{ route('online.update', $daybook->id) }}">
            @csrf
            @method('POST')
             ...
             <div class="form-group row">
                            ...
                            <div class="col-md-6" id="credit">
                                <label for="credit">Amount:</label>
                                 <input class="form-control" type="text" name="total_amount"  oninput="checkAmount()"  id="amount_id" min="0" step="0.01" required onkeypress="return /[0-9.]/i.test(event.key)"   required value="{{ $daybook->amount }}">
