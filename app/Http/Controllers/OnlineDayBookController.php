...
class OnlineDayBookController extends Controller
{
     public function list(Request $request)
    {
        if($request->start_date==null  && $request->end_date==null)
        {
             $daybook = OnlineDayBook::where('date', date('Y-m-d'))->get();
        ...
        {
             $daybook = OnlineDayBook::where('date', $request->start_date)->get();
        ...
        {
             $daybook = OnlineDayBook::where('date', $request->end_date)->get();
            $godowndaybook = GodownDayBook::where('date', $request->end_date)->get();
            $onlinedaybook = OnlineDayBook::where('date', $request->end_date)->get();
        }
        else
        {
            $daybook = OnlineDayBook::whereBetween('date',[$request->start_date,$request->end_date])->get();
    ...
    public function edit($id)
    {
        ...
        $denominationTotal = Denomination::Where('online_daybook_id',$daybook->id);
        ...
        $denominationsArray = array_filter($emptyRemoved, 'strlen');
         return view('onlinedaybook.edit', compact('daybook', 'headings', 'subheading', 'denominations', 'date','denomination_1','denomination_2','denomination_5','denomination_10','denomination_20','denomination_50','denomination_100','denomination_200','denomination_500','denominationsArray','denominationTotal'));
    }
    public function update(Request $request, $id)
        ...
        else
        {
             ...
             return redirect()->route('online.list')->with('success', 'Daybook record updated successfully!');  
        }
